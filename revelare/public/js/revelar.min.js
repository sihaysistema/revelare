(function () {
  ...
  var script = {
    ...
    methods: {
      openInWaze: function openInWaze() {
        // Para abrir en movil
        var url = "https://waze.com/ul?q=" + (this.tripData.latitude) + "," + (this.tripData.longitude) + "&navigate=yes&zoom=17";
        if (this.detectMob()) {
      ...
      openInGoogleMaps: function openInGoogleMaps() {
        ...
        var url = "https://www.google.com/maps/dir/?api=1&travelmode=driving&layer=traffic&destination=" + (this.tripData.latitude) + "," + (this.tripData.longitude);
        if (this.detectMob()) {
          window.open(url).focus();
        } else {
        ...
        _c("div", { staticClass: "card-body" }, [
          _c("div", { staticClass: "row mb-4" }, [
            _c("div", { staticClass: "col-sm-6 mb-sm-0 mb-3 d-flex" }, [
              ...
              _vm._v(" "),
              _c("div", [
                _c("span", [_vm._v(_vm._s(_vm.__("Para entregar el")) + ":")]),
                _vm._v(" "),
            ...
            _c("div", { staticClass: "col-sm-6 d-flex" }, [
              ...
              _vm._v(" "),
              _c("div", [
                _c("span", [_vm._v(_vm._s(_vm.__("Entregado el")) + ": ")]),
                _vm._v(" "),
                _c("p", { staticClass: "mb-0 pt-1 font-w500 text-black" }, [
                  _vm._v(
                    "\n              " +
                      _vm._s(_vm.tripData.completed_on) +
                      "\n            "
                  )
                ])
              ])
  ...
  var dummy = [
    {
      "idx": 0,
      "customer": "Athena Themis",
      "requested_time": "10-09-2021 11:23:54",
      "completed_on": "10-09-2021 12:23:54",
      "docname": "MAT-DT-2021-00001",
      "doctype": "Delivery Note",
      "contact": "Athena Themis",
      "phone": "33633893",
      "address": "km 15.5 Carretera a El Salvador, Edificio Plaza Concepción, Condado Concepción, Cdad. de Guatemala 01051",
      "latitude": "14.5527047",
      "longitude": "-90.4533244",
      "status": "active"
    },
    {
      "idx": 1,
      "customer": "Martín Patroklos",
      "requested_time": "10-09-2021 11:23:54",
      "completed_on": "11-09-2021 12:23:55",
      "docname": "MAT-DT-2021-00002",
      "doctype": "Delivery Note",
      "contact": "Martín Patroklos",
      "phone": "33633893",
      "address": "km 15.5 Carretera a El Salvador, Edificio Plaza Concepción, Condado Concepción, Cdad. de Guatemala 01051",
      "latitude": "14.5527047",
      "longitude": "-90.4533244",
    ...
    {
      "idx": 2,
      "customer": "Antheia Argos",
      "requested_time": "10-09-2021 11:23:54",
      "completed_on": "10-09-2021 12:23:54",
      "docname": "MAT-DT-2021-00003",
      "doctype": "Delivery Note",
      "contact": "Antheia Argos",
      "phone": "33633893",
      "address": "km 15.5 Carretera a El Salvador, Edificio Plaza Concepción, Condado Concepción, Cdad. de Guatemala 01051",
      "latitude": "14.5527047",
      "longitude": "-90.4533244",
    ...
    {
      "idx": 3,
      "customer": "Amada Victoria",
      "requested_time": "10-09-2021 11:23:54",
      "completed_on": "10-09-2021 12:24:54",
      "docname": "MAT-DT-2021-00004",
      "doctype": "Delivery Note",
      "contact": "Amada Victoria",
      "phone": "33633893",
      "address": "km 15.5 Carretera a El Salvador, Edificio Plaza Concepción, Condado Concepción, Cdad. de Guatemala 01051",
      "latitude": "14.5527047",
      "longitude": "-90.4533244",
    ...
    {
      "idx": 4,
      "customer": "Nilo Rosaura",
      "requested_time": "10-09-2021 11:23:54",
      "completed_on": "10-09-2021 12:23:54",
      "docname": "MAT-DT-2021-00005",
      "doctype": "Delivery Note",
      "contact": "Nilo Rosaura",
      "phone": "33633893",
      "address": "km 15.5 Carretera a El Salvador, Edificio Plaza Concepción, Condado Concepción, Cdad. de Guatemala 01051",
      "latitude": "14.5527047",
      "longitude": "-90.4533244",
    ...
    {
      "idx": 5,
      "customer": "Isaque Calliope",
      "requested_time": "10-09-2021 11:23:54",
      "completed_on": "10-09-2021 12:23:54",
      "docname": "MAT-DT-2021-00006",
      "doctype": "Delivery Note",
      "contact": "Isaque Calliope",
      "phone": "33633893",
      "address": "km 15.5 Carretera a El Salvador, Edificio Plaza Concepción, Condado Concepción, Cdad. de Guatemala 01051",
      "latitude": "14.5527047",
      "longitude": "-90.4533244",
  ...
  var script$1 = {
    ...
    computed: {
      numberOfActives: function numberOfActives() {
        return this.stops.filter(function (trip) { return trip.status === "active"; }).length;
      },
      numberOfOverdues: function numberOfOverdues() {
        return this.stops.filter(function (trip) { return trip.status === "overdue"; }).length;
      },
      numberOfPending: function numberOfPending() {
        return this.stops.filter(function (trip) { return trip.status === "pending"; }).length;
      },
      numberOfCompleted: function numberOfCompleted() {
        return this.stops.filter(function (trip) { return trip.status === "completed"; }).length;
      },
    },
  };
  ...
  var __vue_render__$1 = function() {
    ...
    return _c("div", { staticClass: "shs-container-fluid" }, [
      ...
      _vm._v(" "),
      _c("pre", [_vm._v(_vm._s(_vm.nowDateTime) + " ")]),
      _vm._v(" "),
      _c(
        "div",
        { staticClass: "row" },
